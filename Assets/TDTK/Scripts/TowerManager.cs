...
namespace TDTK
{
	...
	public class TowerManager : MonoBehaviour
	{
		...
		public static List<UnitTower> GetAllTowerOfType1(int prefabID)
		{   //find all similar tower (using prefabID)
		...
		public static void UpgradeAllTowerOfType(int prefabID)
		{   //not in used
		...
		*/
		...
		public static void PreBuildTower(UnitTower tower)
		{
			...
			if (platform != null && tower.gameObject.name != "MeleeTroop(Clone)" && tower.gameObject.name != "RangedTroop(Clone)" && tower.gameObject.name != "AOETroop(Clone)")
			{
			...
			if (tower.gameObject.name != "MeleeTroop(Clone)" || tower.gameObject.name != "RangedTroop(Clone)" || tower.gameObject.name != "AOETroop(Clone)")
			{
